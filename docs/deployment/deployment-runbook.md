...
# Build API service
cd services/api
docker build -t acr.azurecr.io/unified-health-api:$VERSION .
docker push acr.azurecr.io/unified-health-api:$VERSION

# Build Web app
cd ../../apps/web
docker build -t acr.azurecr.io/unified-health-web:$VERSION .
docker push acr.azurecr.io/unified-health-web:$VERSION
...
kubectl set image deployment/unified-health-api \
  api=acr.azurecr.io/unified-health-api:v1.1.0 -n unified-health
