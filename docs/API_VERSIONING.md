...
```
https://api.unifiedhealthcare.com/api/v1/patients
https://api.unifiedhealthcare.com/api/v2/patients
```
...
Link: <https://api.unifiedhealthcare.com/api/v2/patients>; rel="successor-version"
