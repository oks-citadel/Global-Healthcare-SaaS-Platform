...
### Internal Services
- [Services Overview](./services/README.md) - Internal platform services documentation
- [Billing Reconciliation](./services/BILLING_RECONCILIATION.md) - Stripe payment reconciliation service
- [Impersonation Service](./services/IMPERSONATION.md) - Admin user impersonation for support
...
├── services/                          # Internal Services Documentation
│   ├── README.md                      # Services overview
│   ├── BILLING_RECONCILIATION.md     # Stripe reconciliation service
│   └── IMPERSONATION.md              # Admin impersonation service
