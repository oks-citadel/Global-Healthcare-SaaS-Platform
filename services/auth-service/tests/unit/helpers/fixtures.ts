...
export const mockMfaUser = {
  ...
  mfaBackupCodes: ["hashedcode1", "hashedcode2", "hashedcode3"],
...
// Note: Do not include iat/exp here - let jwt.sign() generate them
// to avoid conflicts with expiresIn option in tests
...
export const mockAccessToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJ1c2VyLTEyMyIsImVtYWlsIjoidGVzdEBleGFtcGxlLmNvbSIsInJvbGUiOiJwYXRpZW50IiwiaWF0IjoxNzA0ODQ0ODAwLCJleHAiOjE3MDQ4NDU3MDB9.test_signature";
