...
describe('PaymentService', () => {
  ...
  describe('createSubscription', () => {
    it('should create a subscription successfully', async () => {
      ...
      vi.mocked(stripeLib.attachPaymentMethod).mockResolvedValue({} as any);
      ...
      expect(stripeLib.attachPaymentMethod).toHaveBeenCalledWith(
        'pm_123456',
        'cus_123456'
      );
      ...
      expect(stripeLib.createStripeSubscription).toHaveBeenCalledWith({
  ...
  describe('cancelSubscription', () => {
    it('should cancel subscription at period end', async () => {
      ...
      vi.mocked(prisma.subscription.findFirst).mockResolvedValue(mockDbSubscription as any);
