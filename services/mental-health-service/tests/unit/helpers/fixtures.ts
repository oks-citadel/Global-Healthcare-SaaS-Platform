...
export const mockCrisisIntervention = {
  ...
  patientId: 'patient-123',
  responderId: null,
  crisisType: 'suicidal_ideation' as const,
...
export const mockResolvedCrisisIntervention = {
  ...mockCrisisIntervention,
  id: 'crisis-resolved-123',
...
export const mockScheduledTherapySession = {
  id: 'session-scheduled-123',
  patientId: 'patient-123',
...
export const mockCompletedTherapySession = {
  ...mockScheduledTherapySession,
  id: 'session-completed-123',
  status: 'completed' as const,
  actualStartTime: new Date('2026-02-01T14:00:00Z'),
  actualEndTime: new Date('2026-02-01T15:00:00Z'),
  notes: 'Patient showed good progress. Discussed coping strategies.',
  homework: 'Practice mindfulness exercises 10 minutes daily',
  nextSessionDate: new Date('2026-02-08T14:00:00Z'),
};
