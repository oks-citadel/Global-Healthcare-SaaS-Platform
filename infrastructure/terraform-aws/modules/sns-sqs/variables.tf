...
variable "environment" {
  ...
  validation {
    condition     = contains(["production", "prod", "staging", "stg", "development", "dev"], var.environment)
    error_message = "Environment must be one of: production, prod, staging, stg, development, dev."
  }
}
